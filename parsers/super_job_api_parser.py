...
def parse_sj_response_industry_area_specialization(
        industry_area: dict
) -> list[schemas.Specialization]:
    specializations = []
...
def parse_sj_response_industry(industry_area: dict) -> schemas.CompanyIndustry:
    specializations = parse_sj_response_industry_area_specialization(
        industry_area
    )

    return schemas.CompanyIndustry(
        industry_area['key'],
        industry_area['title'],
        specializations
    )
